...
#/usr/bin/python3.6 clean_filenames.py

# youtube-dl now just converts to mp3, so probably don't need this step anymore
#echo "converting to mp3..."
#/usr/bin/python3.6 convert_to_mp3.py
...
#/usr/bin/python3.6 clean_and_convert_transcripts.py

# not getting pairs anymore, so can ditch this as well
#echo "generating list of minimal pairs for each transcript..."
#/usr/bin/python3.6 get_pairs.py
